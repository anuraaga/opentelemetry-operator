...
var (
	...
	errNoLanguageSpecified       = errors.New(fmt.Sprintf("%s must be set to the desired SDK language", annotationLanguage))
	errUnsupportedLanguage       = errors.New(fmt.Sprintf("SDK language not supported, supported languages are (java, nodejs)"))
)
